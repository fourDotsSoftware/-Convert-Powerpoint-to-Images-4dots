...
namespace PowerpointToImagesConverter4dots
{
    class Module
    {
        ...
        public static string ApplicationName = "Convert Powerpoint To Images 4dots";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/PowerpointToImagesConverter/";
        public static string HelpURL = "https://www.4dots-software.com/powerpoint-to-images-converter/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/powerpoint-to-images-converter/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-powerpoint-to-images-converter.php";
        public static string VersionURL = "http://cssspritestool.com/versions/powerpoint-to-images-converter.txt";

        public static string TipText = TranslateHelper.Translate("Great application to Convert Powerpoint to Images !");        
